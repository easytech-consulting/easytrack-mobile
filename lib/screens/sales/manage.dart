                                                              ...
                                                              Container(
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      color: Colors
                                                                          .white,
                                                                      borderRadius:
                                                                          BorderRadius.all(Radius.circular(myHeight(context) /
                                                                              90.0)),
                                                                      border: Border.all(
                                                                          width:
                                                                              1.0,
                                                                  ...
                                                                  child: Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        Padding(
                                                                          padding:
                                                                              EdgeInsets.only(top: myHeight(context) / 62),
                                                                          child:
                                                                              Container(
                                                                            width:
                                                                                myWidth(context),
                                                                        ...
                                                                        Padding(
                                                                            padding:
                                                                                EdgeInsets.only(bottom: myHeight(context) / 200.0),
                                                                            child: Row(
                                                                              children: <Widget>[
                                                                                Container(
                                                                                  child: Stack(
                                                                  ...
                                                                  ? InkWell(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        alignment:
                                                                            Alignment.center,
                                                                        decoration: BoxDecoration(
                                                                            borderRadius: BorderRadius.circular(myHeight(context) /
                                                                                30.0),
                                                                            color:
                                                                  ...
                                                                  children: <
                                                                    ...
                                                                    Row(
                                                                      children: <
                                                                        ...
                                                                        InkWell(
                                                                          onTap: () =>
                                                                              _showDetails(_salesToShow[index]),
                                                                          child:
                                                                              Text(
                                                                            'S0-${_salesToShow[index]["code"]}',
                                                                            style:
                                                                                TextStyle(fontSize: myHeight(context) / 33.0, fontWeight: FontWeight.w500),
                                                                          ),
                                                                        ),
                                                                        Spacer(),
                                                                        GestureDetector(
